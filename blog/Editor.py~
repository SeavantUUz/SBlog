...
class EpicEditorWidget(forms.Textarea):
    ...
    def render(self, name, value, attrs=None):
        ...
        cfg['basePath'] = getattr(settings, 'EPIC_BASEPATH', '/static/EpicEditor/epiceditor')
        cfg_f = {'name': 'body'}
    ...
    def _media(self):
        epic_js = getattr(settings, 'EPIC_JS', '/static/EpicEditor/epiceditor/js/epiceditor.min.js')
